---
description: Work the Conductor board — claim the next task, do it with full context, complete or hand off, repeat.
---

Use the batondeck-worker skill. Run the worker loop against the connected Conductor MCP server:
